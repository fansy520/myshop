...
<form method="post" action="<?php echo U('');?>" onsubmit="return validate()">
    <table cellspacing="0" cellpadding="0" style="margin-top:100px" align="center">
        <tr>
            <td>
                <img src="http://admin.shop.com/Public/Admin/Images/login.png" width="178" height="256" border="0" alt="京东" />
            </td>
                ...
                <table>
                    ...
                    <tr>
                        <td colspan="2" align="center">
                            ...
                            <label for="remember">请保存本次登录信息。</label>
                        </td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
...
<script type='text/javascript'>
    function change_captcha(ele_node){
        var url = '<?php echo U("Captcha/captcha");?>?nocache=' + new Date().getTime();  //随机验证码
        ele_node.src = url;
    }
</script>
</body>
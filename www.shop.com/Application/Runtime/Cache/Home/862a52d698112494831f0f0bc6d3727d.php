...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
    ...
    <link rel="stylesheet" href="http://www.shop.com/Public/Home/css/goods.css" type="text/css">
    ...
    <!--引入jqzoom css -->
    <link rel="stylesheet" href="http://www.shop.com/Public/Home/css/jqzoom.css" type="text/css">
            ...
            <div class="related_view newgoods leftbar mt10">
                ...
                <div class="leftbar_wrap">
                    <ul>
                        <li>
                            <dl>
                                <dt><a href=""><img src="http://www.shop.com/Public/Home/images/relate_view1.jpg" alt="" /></a></dt>
                        ...
                        <li>
                            <dl>
                                <dt><a href=""><img src="http://www.shop.com/Public/Home/images/relate_view2.jpg" alt="" /></a></dt>
                        ...
                        <li>
                            <dl>
                                <dt><a href=""><img src="http://www.shop.com/Public/Home/images/relate_view3.jpg" alt="" /></a></dt>
                        ...
                        <li>
                            <dl>
                                <dt><a href=""><img src="http://www.shop.com/Public/Home/images/relate_view4.jpg" alt="" /></a></dt>
                        ...
                        <li class="last">
                            <dl>
                                <dt><a href=""><img src="http://www.shop.com/Public/Home/images/relate_view5.jpg" alt="" /></a></dt>
        ...
        <div class="goods_content fl mt10 ml10">
            ...
            <div class="summary">
                ...
                <div class="preview fl">
                    <div class="midpic">
                        <!--<a href="http://www.shop.com/Public/Home/images/preview_l1.jpg" class="jqzoom" rel="gal1">   &lt;!&ndash; 第一幅图片的大图 class 和 rel属性不能更改 &ndash;&gt;-->
                            <!--<img src="http://www.shop.com/Public/Home/images/preview_m1.jpg" alt="" />               &lt;!&ndash; 第一幅图片的中图 &ndash;&gt;-->
                        <a href="<?php echo ($row['paths'][0]); ?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
                            <img src="<?php echo ($row['paths'][0]); ?>" alt="" width='350' height="350"/>               <!-- 第一幅图片的中图 -->
                    ...
                    分别指定了中图（smallimage）和大图（largeimage），
                    img标签则显示小图，按此格式循环生成即可，但在第一个li上，要加上cur类，
                    ...
                    <div class="smallpic">
                        ...
                        <div class="smallpic_wrap">
                            <ul>
                                <!--<li class="cur">-->
                                    <!--<a class="zoomThumbActive" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: 'http://www.shop.com/Public/Home/images/preview_m1.jpg',largeimage: 'http://www.shop.com/Public/Home/images/preview_l1.jpg'}"><img src="http://www.shop.com/Public/Home/images/preview_s1.jpg"></a>-->
                                <!--</li>-->
                                <!--<li>-->
                                    <!--<a href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: 'http://www.shop.com/Public/Home/images/preview_m2.jpg',largeimage: 'http://www.shop.com/Public/Home/images/preview_l2.jpg'}"><img src="http://www.shop.com/Public/Home/images/preview_s2.jpg"></a>-->
                                <!--</li>-->
                                <!--<li>-->
                                    <!--<a href="javascript:void(0);" -->
                                       <!--rel="{gallery: 'gal1', smallimage: 'http://www.shop.com/Public/Home/images/preview_m3.jpg',largeimage: 'http://www.shop.com/Public/Home/images/preview_l3.jpg'}">  -->
                                        <!--<img src="http://www.shop.com/Public/Home/images/preview_s3.jpg"></a>-->
                                <!--</li>-->
                                <!--<li>-->
                                    <!--<a href="javascript:void(0);" -->
                                       <!--rel="{gallery: 'gal1', smallimage: 'http://www.shop.com/Public/Home/images/preview_m4.jpg',largeimage: 'http://www.shop.com/Public/Home/images/preview_l4.jpg'}">  -->
                                        <!--<img src="http://www.shop.com/Public/Home/images/preview_s4.jpg"></a>-->
                                <!--</li>-->
                                <!--<li>-->
                                    <!--<a href="javascript:void(0);" -->
                                       <!--rel="{gallery: 'gal1', smallimage: 'http://www.shop.com/Public/Home/images/preview_m5.jpg',largeimage: 'http://www.shop.com/Public/Home/images/preview_l5.jpg'}">  -->
                                        <!--<img src="http://www.shop.com/Public/Home/images/preview_s5.jpg"></a>-->
                                <!--</li>-->
                                <!--<li>-->
                                    <!--<a href="javascript:void(0);" -->
                                       <!--rel="{gallery: 'gal1', smallimage: 'http://www.shop.com/Public/Home/images/preview_m6.jpg',largeimage: 'http://www.shop.com/Public/Home/images/preview_l6.jpg'}">  -->
                                        <!--<img src="http://www.shop.com/Public/Home/images/preview_s6.jpg"></a>-->
                                <!--</li>-->
                                <!--<li>-->
                                    <!--<a href="javascript:void(0);" -->
                                       <!--rel="{gallery: 'gal1', smallimage: 'http://www.shop.com/Public/Home/images/preview_m7.jpg',largeimage: 'http://www.shop.com/Public/Home/images/preview_l7.jpg'}">  -->
                                        <!--<img src="http://www.shop.com/Public/Home/images/preview_s7.jpg"></a>-->
                                <!--</li>-->
                                <!--<li>-->
                                    <!--<a href="javascript:void(0);" -->
                                       <!--rel="{gallery: 'gal1', smallimage: 'http://www.shop.com/Public/Home/images/preview_m8.jpg',largeimage: 'http://www.shop.com/Public/Home/images/preview_l8.jpg'}">  -->
                                        <!--<img src="http://www.shop.com/Public/Home/images/preview_s8.jpg"></a>-->
                                <!--</li>-->
                                <!--<li>-->
                                    <!--<a href="javascript:void(0);" -->
                                       <!--rel="{gallery: 'gal1', smallimage: 'http://www.shop.com/Public/Home/images/preview_m9.jpg',largeimage: 'http://www.shop.com/Public/Home/images/preview_l9.jpg'}">  -->
                                        <!--<img src="http://www.shop.com/Public/Home/images/preview_s9.jpg"></a>-->
                                <?php if(is_array($row["paths"])): foreach($row["paths"] as $key=>$path): ?><li <?php if(($key) == "0"): ?>class="cur"<?php endif; ?> >
                                        <a <?php if(($key) == "0"): ?>class="zoomThumbActive"<?php endif; ?> href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?php echo ($path); ?>-m',largeimage: '<?php echo ($path); ?>-l'}"><img src="<?php echo ($path); ?>"></a>
                ...
                <div class="goodsinfo fl ml10">
                    <ul>
                        ...
                        <li><span>浏览次数：</span><label id='goods-click'></label></li>
                ...
                <div class="detail_bd">
                    ...
                    <div class="comment detail_div mt10 none">
                        ...
                        <div class="comment_items mt10">
                            <div class="user_pic">
                                <dl>
                                    <dt><a href=""><img src="http://www.shop.com/Public/Home/images/user1.gif" alt="" /></a></dt>
                                    <dd><a href="">乖乖</a></dd>
                                </dl>
                            </div>
                            <div class="item">
                        ...
                        <div class="comment_items mt10">
                            <div class="user_pic">
                                <dl>
                                    <dt><a href=""><img src="http://www.shop.com/Public/Home/images/user2.jpg" alt="" /></a></dt>
                                    <dd><a href="">小宝贝</a></dd>
                                </dl>
                            </div>
                            <div class="item">
                        ...
                        <div class="comment_items mt10">
                            <div class="user_pic">
                                <dl>
                                    <dt><a href=""><img src="http://www.shop.com/Public/Home/images/user3.jpg" alt="" /></a></dt>
                                    <dd><a href="">天使</a></dd>
                                </dl>
                            </div>
                            <div class="item">
    ...
    <script type="text/javascript" src="http://www.shop.com/Public/Home/js/goods.js"></script>
    <script type="text/javascript" src="http://www.shop.com/Public/Home/js/jqzoom-core.js"></script>
    <!-- jqzoom 效果 -->
    <script type="text/javascript">
        $(function(){
            $('.jqzoom').jqzoom({
            ...
            //点击次数显示
            $.getJSON('<?php echo U("Goods/clickNum");?>',{id:<?php echo ($row["id"]); ?>},function(response){
